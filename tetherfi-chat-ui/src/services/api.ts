...
const IDENTITY_BASE_URL = import.meta.env.VITE_IDENTITY_URL || 'http://localhost:7277/api';
const CHAT_BASE_URL = import.meta.env.VITE_CHAT_SERVICE_URL || 'http://localhost:7151/api';
...
export const HUB_URL = import.meta.env.VITE_HUB_URL || 'http://localhost:7151/chathub';
